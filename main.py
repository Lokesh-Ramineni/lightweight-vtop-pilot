...
#
#         for attempt in range(self.login_tries):
#             client = get_client()
#             session_check=False
#
...
#                     f.write(r.content)
#                 return client,get_csrf_token(r.text)
...
#                         return client,get_csrf_token(postprelog.text)
#
#                 except Exception as e:
#                     print(f'Error:{e}')
#
#                 return client,get_csrf_token(html_src)
# async def start():
